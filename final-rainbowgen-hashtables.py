...
# Asking user to choose a hashing algorithm from the following
...
# Generating 1000 random passwords and hashing them using the chosen algorithm
passwords = []
...
# Function to reduce a hash string to a password using an iteration and an alphabet
...
# Asking user to enter a hash value to find the original password
